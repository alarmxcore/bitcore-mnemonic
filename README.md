BIP39 Mnemonics for Bitcore-alarmx
=======

A module for [bitcore-alarmx](https://github.com/alarmxcore/bitcore-alarmx) that implements [Mnemonic code for generating deterministic keys](https://github.com/bitcoin/bips/blob/master/bip-0039.mediawiki).
